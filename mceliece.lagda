...
ni'o la .varik.\ cu na jinvi le du'u sarcu fa lo nu la .varik.\ cu ciksi le me'oi .\AgdaKeyword{private}.\ ja la .\F{afnos}.\ ja la .\F{afpas}.\ ja la .\F{afres}.\ ja la .\F{afcis}.\ ja la .\F{afyvos}.\ bau la .lojban.\sds  .i la'e di'u pluka la .varik.\ ki'u le su'u la .varik.\ cu toldji lo nu lo zo'oi .\texttt{paragraph}.\ co'e cu vasru zo'e joi lo zo'oi .\texttt{code}.\ co'e
...
\begin{code}
  ...
  afres : {n : ℕ}
        ...
        → zmaduse $ m ∷ t
  afres t@(_ ∷ _) _ m l = l' Gex.∷ f t
    where
    l' = subst₂ ℕ._≤_ (luzyr t m) (lusuk t m) l
    f : Vec _ _ → Gex.All _ _
    f (_ ∷ []) = Gex.[]
    f t@(_ ∷ _ ∷ _) = {!!}
  ...
  afmus : {n : ℕ}
        ...
        → zmaduse $ m ∷ t
        → zmaduse t
  afmus [] _ _ = Data.Unit.Polymorphic.tt
...
ni'o la'o zoi.\ \AgdaField{Private.Γ} \B p .zoi.\ lo'i ro cpolinomi'a be fi la'o zoi.\ \AgdaField{Private.lg} \B p bei fo ko'a goi la'o zoi.\ \D{Fin} \OpF \$ \AgdaField{Private.q} \B .zoi.\ be'o ku pi'u lo'i ro porsi be fi ko'a be'o poi la'o zoi.\ \AgdaField{Private.n} \B p .zoi.\ nilzilcmi ke'a
