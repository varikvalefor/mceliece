...
\chap{le vrici}
ni'o la'au \chapsname\ li'u vasru zo'e poi na racli fa lo nu zbasu lo ckupau poi ke'a xi pa se srana lo ro selvau be ke'a xi re
...
\section{la'oi .\F{hw𝕄}.}
ni'o la'o zoi.\ \F{hw𝕄} \B t\ .zoi.\ grisumji lo se cmima poi ro da zo'u ga jo da cmima ke'a gi su'o de poi ke'a xi re co'e ja rajypau la'oi .\B{t}.\ zo'u da mu'oi glibau.\ HAMMING weight .glibau.\ de
...
FieldOrdering {p} f = mapₘ α $ sartre $ indice a
  ...
  sartre = mapₘ jort ∘ panci
    ...
    jort = mapᵥ proj₂ ∘ jort' ∘ mapᵥ (λ (a , b) → show a ,_ $ a , b)
      where
      jort' : Op₁ _
      jort' = {!!}
\end{code}
